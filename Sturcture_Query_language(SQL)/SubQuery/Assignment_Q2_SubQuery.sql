...
INSERT INTO Student5 VALUES('Trishala','bhisi@gmail.com','Nagpur','Dotnet',11012),
						   ...
						   ('Sayali','sayli@gmail.com','Nagpur','PHP',11015),
...
SELECT * FROM Fees5 
WHERE Course_ID IN (SELECT Course_ID FROM Student5 WHERE Course = 'Java');

SELECT * FROM Fees5 
WHERE Course_ID IN (SELECT Course_ID FROM Student5 WHERE Course = 'Dotnet');

SELECT * FROM Fees5 
WHERE Course_ID IN (SELECT Course_ID FROM Student5 WHERE Course = 'PHP');